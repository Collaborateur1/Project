...
@Path( "/login" )
public class RouteProLogin extends WebContext {

    public RouteProLogin( @Context SecurityContext securityContext ) {
        super( securityContext );
        // TODO Auto-generated constructor stub
    }

    private static Logger logger         = Logger.getLogger( RouteProLogin.class );
