...
public class Attachment_ {
    ...
    public static volatile SingularAttribute<Attachment, Integer> idattachment;
    ...
    public static volatile SetAttribute<Attachment, BuisnessHasServiceHasAttachment> buisnessHasServiceHasAttachmentAttachmentViaAttachmentIdattachment;
    public static volatile SetAttribute<Attachment, Hairdresser> hairdresserAttachmentViaProfilePicture;

    public static volatile SetAttribute<Attachment, Buisness> buisnessBuisnessHasAttachmentViaIdbuisness;
    public static volatile SetAttribute<Attachment, Client> clientClientHasAttachmentViaIdclient;
