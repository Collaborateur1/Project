...
document.addEventListener( "documentReady",documentReady);
document.addEventListener( "windowLoad",windowLoad);
     ...
     var documentReady = function(){
        ...
        addEventListener('scroll', function(evt) {
                //if(!mr.scroll.assisted){
                    document.mr.scroll.y = window.pageYOffset;
                //}
                document.mr.scroll.update(evt);
        }, false);
